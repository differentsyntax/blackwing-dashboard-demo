    ...
    <div className="relative p-0.5 rounded-lg overflow-hidden col-span-1 border">
      ...
      <div className="relative z-10 p-4 bg-zinc-900 rounded-lg border-2 border-transparent flex flex-col">
        ...
        <p className="text-gray-400 text-sm text-justify my-2">
          We believe that financial freedom is for everyone. Borders, income, or
          birthplace should not limit a person's ability to take a loan, open a
          savings account, or transfer money. With Blackwing, we're taking this
          dream one step forward.
        </p>
        <p className="text-gray-400 text-sm text-justify my-2">
